    ...
    public class Cities : List<City>
    {
        ...
        public void OpenCityList(string fileName)
        {
            ...
            try
            {
                ...
                {
                    this.Add(new City(null,
                        float.Parse(city["Y"].ToString()),
                        float.Parse(city["X"].ToString())));
                    i++;
                }
            }
            finally
        ...
        public void OpenCityList(List<Geocache> r)
        {
            this.Clear();
            foreach (Geocache geo in r)
            {
                this.Add(new City(geo, (float)(geo._dLongitude), (float)(geo._dLatitude)));
            }
        }
    }
}
